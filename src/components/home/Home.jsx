...
function Home() {
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(`${apiBaseUrl}/classes/filter/byAttributes?danceCategory=${search}`,{headers: {Authorization: `Bearer ${auth.token}`}});
    ...
    const handleSubmitRating = async (classId) => {
        ...
        try {
            await axios.post(`${apiBaseUrl}/classes/rate/${classId}`, { rating: studentRating }, {
